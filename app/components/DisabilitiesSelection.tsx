...
export default function DisabilitiesSelection() {
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-screen bg-[#0B0D18] text-white px-4 ${robotoCondensed.className}`}>
      ...
      <h1 className="text-2xl md:text-3xl font-medium text-center">Select your disability</h1>
      {/* curved line */}
      <svg
      ...
      <p className="mt-10 text-center font-bold text-lg">Please select from the following disabilities </p>
      <p className="text-sm text-gray-400">we need a full body scan so take a picture for your whole body</p>
      

      <button className="mt-6 px-10 py-3 bg-gradient-to-r from-pink-500 to-blue-500 text-white font-semibold rounded-lg">NEXT</button>
